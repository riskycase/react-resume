    ...
    <section className="home section" id="home">
      ...
      <div className="home__container bd-grid">
        ...
        <div className='home__contact bd-grid'>
          ...
          <BoxIcon className="home__icon bx-envelope" label={`Write an email to ${name}`} url={`mailto:${email}`} />
          <BoxIcon className="home__icon bx-phone" label={`Dial ${name}'s phone`} url={`tel:${telephone}`} />
